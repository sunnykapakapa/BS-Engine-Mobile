...
typedef WeekFile =
{
	...
	var temcutscene:Bool;
	var cutscenombre:String;
}
...
class WeekData {
	...
	public var temcutscene:Bool;
	public var cutscenombre:String;
	...
	public function new(weekFile:WeekFile) {
		...
		temcutscene = weekFile.temcutscene;
		cutscenombre = weekFile.cutscenombre;
	}
